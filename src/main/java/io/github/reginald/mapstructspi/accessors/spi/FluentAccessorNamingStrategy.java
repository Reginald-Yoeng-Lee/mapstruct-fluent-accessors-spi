...
public class FluentAccessorNamingStrategy extends DefaultAccessorNamingStrategy {
    ...
    public String getPropertyName(ExecutableElement getterOrSetterMethod) {
        ...
        /* in this case method is neither fluent/builder nor basic setter/getter */
        return super.getPropertyName(getterOrSetterMethod);
    }
    ...
    private boolean isSamePropertyNameExist(ExecutableElement getterOrSetterMethod) {
        ...
        for (Element element : params) {
            if (!element.equals(getterOrSetterMethod) &&
    ...
    protected boolean isMyFluentSetter(ExecutableElement getterOrSetterMethod) {
        return getterOrSetterMethod.getParameters().size() == 1 &&
                typeUtils.isSameType(getterOrSetterMethod.getReturnType(), getterOrSetterMethod.getEnclosingElement().asType());
    }
}
